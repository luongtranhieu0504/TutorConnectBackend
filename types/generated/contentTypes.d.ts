...
export interface ApiConversationConversation
  ...
  attributes: {
    ...
    lastTimestamp: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageUrls: Schema.Attribute.Media<undefined, true>;
...
export interface ApiScheduleSchedule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slots: Schema.Attribute.Component<'schedule.slot', true>;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    favorites: Schema.Attribute.Relation<'manyToMany', 'api::tutor.tutor'>;
    learning_history: Schema.Attribute.Relation<
      'manyToMany',
      'api::schedule.schedule'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTutorTutor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    availability: Schema.Attribute.Component<'schedule.slot', true>;
    bio: Schema.Attribute.RichText;
    certifications: Schema.Attribute.Component<'award.certification', true>;
    conversations: Schema.Attribute.Relation<
      'oneToMany',
      'api::conversation.conversation'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    degrees: Schema.Attribute.String;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    photoUrl: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    sentMessages: Schema.Attribute.Relation<
      ...
      'api::message.message'
    >;
    state: Schema.Attribute.Enumeration<['online', 'offline']>;
    student: Schema.Attribute.Relation<'oneToOne', 'api::student.student'>;
    tutor: Schema.Attribute.Relation<'oneToOne', 'api::tutor.tutor'>;
    type_role: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
